/*!
 * Photo Sphere Viewer / Compass Plugin 5.13.1
...
// src/compass.svg
var compass_default = '<?xml version="1.0" encoding="utf-8"?><!-- Generator: Adobe Illustrator 24.3.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  --><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"	 viewBox="0 0 100 100" style="enable-background:new 0 0 100 100;" xml:space="preserve"><style type="text/css">	.st0{fill:#FFFFFF;}</style><path class="st0" d="M50,0C22.3,0-0.1,22.4-0.1,50.1s22.4,50.1,50.1,50.1s50.1-22.4,50.1-50.1S77.7,0,50,0z M50,94.4	c-24.5,0-44.3-19.8-44.3-44.3C5.7,25.6,25.5,5.8,50,5.8s44.3,19.8,44.3,44.3S74.5,94.4,50,94.4z"/><circle class="st0" cx="50" cy="50.1" r="7.4"/></svg>\n';
...
var CompassComponent = class extends AbstractComponent {
  ...
  __drawMarker(context, marker) {
    ...
    if (marker.isPoly()) {
      context.beginPath();
      marker.definition[0].forEach(([yaw, pitch], i) => {
